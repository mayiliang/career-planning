...
<style scoped>
.notes-page{width:100%;max-width:1600px;padding:0}.notes-header{align-items:center;min-height:58px;margin:0;padding:0 2px 12px}.notes-header>div{display:grid;grid-template-columns:auto minmax(260px,1fr);grid-template-rows:auto auto;column-gap:18px;align-items:center;min-width:0}.notes-header p{grid-column:1;grid-row:1;margin:0}.notes-header h1{grid-column:1;grid-row:2;margin:0;font-size:clamp(1.65rem,2.3vw,2.15rem);line-height:1.05;letter-spacing:-.035em}.notes-header span{grid-column:2;grid-row:1/-1;max-width:560px;font-size:.78rem;line-height:1.5}.notes-shell{grid-template-columns:360px 1fr;min-height:calc(100vh - 100px);border-color:#dbe3ec;border-radius:18px;box-shadow:0 18px 50px rgba(24,48,79,.09)}.notes-index{max-height:calc(100vh - 100px);background:linear-gradient(180deg,#f6f9fc,#f2f6fa)}.notes-index section button.active{border:1px solid #dfe7f0;box-shadow:0 7px 22px rgba(27,54,88,.08)}.note-reader{max-height:calc(100vh - 100px);padding:24px 28px}.note-reader>header{align-items:center;padding-bottom:14px}.note-reader>header h2{margin:3px 0;font-size:1.45rem}.note-reader nav{margin:14px 0;padding:4px;background:#f1f5f9;border:1px solid #e0e6ed;border-radius:12px;width:max-content}.note-reader nav button{border:0;background:transparent}.note-reader nav button.active{background:linear-gradient(135deg,#1c3556,#285e88);box-shadow:0 6px 16px rgba(30,69,108,.18)}
@media(max-width:1100px){.notes-header>div{grid-template-columns:auto 1fr}.notes-shell{grid-template-columns:320px 1fr}}
@media(max-width:850px){.notes-page{padding:0}.notes-header{align-items:stretch;gap:9px}.notes-header>div{grid-template-columns:1fr}.notes-header p,.notes-header h1,.notes-header span{grid-column:1;grid-row:auto}.notes-header span{margin-top:3px}.notes-shell{grid-template-columns:1fr;min-height:0}.note-reader{max-height:none;padding:20px}}
</style>

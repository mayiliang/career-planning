...
> 资料重构进度：2026-09-23，B01～B25 已接入统一资料目录、概念交叉引用与阅读路线；B25 重写持续交付、代理部署、可观测性与性能四篇，补充制品、路由缓存、任务归属、采样与主线程交互例子，接入 48 个概念入口与 16 条关联。
...
| `pnpm content:check` | 检查知识内容、B01～B25 讲义结构和发音资源 |

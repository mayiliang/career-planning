...
> 资料重构进度：2026-09-12，B01～B12 已接入统一资料目录、概念交叉引用与阅读路线；B12 完成架构表达、事故复盘、代码评审、CSS 布局与现代 CSS 五篇重写，补充架构图、完整模拟案例和可操作的桌面页面，接入 61 个概念入口、20 条关联与 23 个重点术语发音。
...
| `pnpm content:check` | 检查知识内容、B01～B12 讲义结构和发音资源 |

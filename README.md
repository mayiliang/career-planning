...
> 资料重构进度：2026-09-24，B01～B26 已接入统一资料目录、概念交叉引用与阅读路线；B26 重写网络加载、主线程响应、内存资源与视口布局四篇，补充条件响应、可取消搜索、预览释放与桌面布局实验，接入 48 个概念入口与 16 条关联。
...
| `pnpm content:check` | 检查知识内容、B01～B26 讲义结构和发音资源 |

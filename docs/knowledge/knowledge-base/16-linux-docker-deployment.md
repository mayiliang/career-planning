...
- [ ] 自评已掌握
- [ ] 已通过严格考核
- 学习资料：[中文核心讲义](../chinese-guides/advanced-topics.md#linux-02)、[procps-ng Manual](https://gitlab.com/procps-ng/procps)（英文原文，仅用于版本核验）、[iproute2 Documentation](https://wiki.linuxfoundation.org/networking/iproute2)（英文原文，仅用于版本核验）、[systemd Journal](https://www.freedesktop.org/software/systemd/man/latest/journalctl.html)（英文原文，仅用于版本核验）。英文原文仅用于版本核验，不作为必读或独立首考题源。覆盖范围：围绕「进程、端口、日志与网络诊断」的定义、机制、边界、反例和通过标准；首考不得引入未列资料或题目未点名的框架/项目场景。
...
- [ ] 自评已掌握
- [ ] 已通过严格考核
- 学习资料：[中文核心讲义](../chinese-guides/advanced-topics.md#linux-04)、[OpenSSH Manual](https://www.openssh.com/manual.html)（英文原文，仅用于版本核验）、[OWASP Server Security](https://cheatsheetseries.owasp.org/cheatsheets/Transport_Layer_Security_Cheat_Sheet.html)（英文原文，仅用于版本核验）、[Ubuntu Server Security](https://documentation.ubuntu.com/server/how-to/security/)（英文原文，仅用于版本核验）。英文原文仅用于版本核验，不作为必读或独立首考题源。覆盖范围：围绕「服务器安全、SSH、用户与基础防护」的定义、机制、边界、反例和通过标准；首考不得引入未列资料或题目未点名的框架/项目场景。

...
- [ ] 自评已掌握
- [ ] 已通过严格考核
- 学习资料：[Vue Quick Start](https://vuejs.org/guide/quick-start.html)、[Single-File Components](https://vuejs.org/guide/scaling-up/sfc.html)、[Vite Guide](https://vite.dev/guide/)。覆盖范围：围绕「Vite 脚手架、SFC 与项目结构」的定义、机制、边界、反例和通过标准；首考不得引入未列资料或题目未点名的框架/项目场景。
...
- [ ] 自评已掌握
- [ ] 已通过严格考核
- 学习资料：[Reactivity Fundamentals](https://vuejs.org/guide/essentials/reactivity-fundamentals.html)、[Computed Properties](https://vuejs.org/guide/essentials/computed.html)、[Reactivity in Depth](https://vuejs.org/guide/extras/reactivity-in-depth.html)。覆盖范围：围绕「`ref`、`reactive`、`computed` 与响应式边界」的定义、机制、边界、反例和通过标准；首考不得引入未列资料或题目未点名的框架/项目场景。
...
- [ ] 自评已掌握
- [ ] 已通过严格考核
- 学习资料：[Template Syntax](https://vuejs.org/guide/essentials/template-syntax.html)、[Event Handling](https://vuejs.org/guide/essentials/event-handling.html)、[Form Input Bindings](https://vuejs.org/guide/essentials/forms.html)。覆盖范围：围绕「模板语法、指令、事件与表单」的定义、机制、边界、反例和通过标准；首考不得引入未列资料或题目未点名的框架/项目场景。
...
- [ ] 自评已掌握
- [ ] 已通过严格考核
- 学习资料：[Props](https://vuejs.org/guide/components/props.html)、[Component Events](https://vuejs.org/guide/components/events.html)、[Slots](https://vuejs.org/guide/components/slots.html)、[Component v-model](https://vuejs.org/guide/components/v-model.html)。覆盖范围：围绕「Props、Emits、Slots 与组件 `v-model`」的定义、机制、边界、反例和通过标准；首考不得引入未列资料或题目未点名的框架/项目场景。
...
- [ ] 自评已掌握
- [ ] 已通过严格考核
- 学习资料：[Lifecycle Hooks](https://vuejs.org/guide/essentials/lifecycle.html)、[Watchers](https://vuejs.org/guide/essentials/watchers.html)。覆盖范围：围绕「生命周期、`watch`、`watchEffect` 与副作用清理」的定义、机制、边界、反例和通过标准；首考不得引入未列资料或题目未点名的框架/项目场景。
...
- [ ] 自评已掌握
- [ ] 已通过严格考核
- 学习资料：[Composables](https://vuejs.org/guide/reusability/composables.html)、[Provide / Inject](https://vuejs.org/guide/components/provide-inject.html)。覆盖范围：围绕「Composable、依赖注入与逻辑复用」的定义、机制、边界、反例和通过标准；首考不得引入未列资料或题目未点名的框架/项目场景。
...
- [ ] 自评已掌握
- [ ] 已通过严格考核
- 学习资料：[Vue Router Guide](https://router.vuejs.org/guide/)、[Route Lazy Loading](https://router.vuejs.org/guide/advanced/lazy-loading.html)、[Navigation Guards](https://router.vuejs.org/guide/advanced/navigation-guards.html)。覆盖范围：围绕「Vue Router、懒加载与导航守卫」的定义、机制、边界、反例和通过标准；首考不得引入未列资料或题目未点名的框架/项目场景。
...
- [ ] 自评已掌握
- [ ] 已通过严格考核
- 学习资料：[Pinia Core Concepts](https://pinia.vuejs.org/core-concepts/)、[Defining a Store](https://pinia.vuejs.org/core-concepts/)、[Testing Stores](https://pinia.vuejs.org/cookbook/testing.html)。覆盖范围：围绕「Pinia 与状态分层」的定义、机制、边界、反例和通过标准；首考不得引入未列资料或题目未点名的框架/项目场景。
...
- [ ] 自评已掌握
- [ ] 已通过严格考核
- 学习资料：[Vue Test Utils](https://test-utils.vuejs.org/guide/)、[Vue Testing Guide](https://vuejs.org/guide/scaling-up/testing.html)、[Vue Performance](https://vuejs.org/guide/best-practices/performance.html)、[Vite Build](https://vite.dev/guide/build)。覆盖范围：围绕「组件测试、性能与生产构建」的定义、机制、边界、反例和通过标准；首考不得引入未列资料或题目未点名的框架/项目场景。

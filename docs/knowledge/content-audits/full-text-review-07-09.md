...
2026-09-24：B26 的 PERF-02、PERF-03、PERF-04、H5-01 已按知识点重写，补充可运行例子、跨篇引用与桌面阅读核对；网络条件响应、取消搜索、预览释放与布局实验的证据，以及真实性能、堆快照和移动宿主未验证范围，见[学习资料系统的 B26 记录](../../development/11-learning-material-system.md#b26-的加载响应与资源布局)。后文保留历史审校记录。

2026-09-23：B25 的 PERF-01 已按知识点重写，补充中文情境、可观察例子、概念交叉引用与桌面核对；本地实验与尚未执行的 Nginx/TLS/CDN、真实发布和真实访问测量分别记录，见[学习资料系统的 B25 记录](../../development/11-learning-material-system.md#b25-的版本交付与用户体验)。后文保留历史审校记录。

2026-09-22：B23 的 COMP-02 已按知识点重写，补充示例、交叉引用与桌面阅读核对；内容范围、运行证据及 Linux 实验尚未实机执行的限制见[学习资料系统的 B23 记录](../../development/11-learning-material-system.md#b23-的交互所有权与交付证据)。后文保留历史审校记录。

2026-09-21：B22 的 COMP-01 已按知识点重写，补充可运行示例、跨篇引用及桌面阅读核对；当前内容与验证边界见[学习资料系统的 B22 记录](../../development/11-learning-material-system.md#b22-的查询写入与实时组件)。后文保留历史审校记录。

2026-09-19：B18 的相关主讲义已再次按知识点重构，并核对当前官方参考、正文示例与桌面阅读；当前内容及验证边界见[学习资料系统的 B18 记录](../../development/11-learning-material-system.md#b18-的-node-执行、文件管线与协作交付)。本记录后文保留各原复核日期的历史结论。

...
| 资料 | 全文观察 | 当前判定 |
| --- | --- | --- |
| [07–09 讲义：PERF-01](../chinese-guides/content-audit-07-09.md#perf-01) | 指标、p75、预算、实验室/RUM、反例和复测闭环；固定版本已改为运行时记录 | 保留，主讲义 |
...
| [07–09 讲义：PERF-02](../chinese-guides/content-audit-07-09.md#perf-02) | 已补脱敏 HAR、瀑布阶段、缓存、资源提示、预取/预渲染/bfcache 和副作用 | 保留，主讲义 |
...
| [07–09 讲义：PERF-03](../chinese-guides/content-audit-07-09.md#perf-03) | trace、LoAF、Long Task、INP、observer 成本和受限归因闭环 | 保留，主讲义 |
...
| [07–09 讲义：PERF-04](../chinese-guides/content-audit-07-09.md#perf-04) | 可达性、retaining path、重复趋势、资源释放和弱引用边界完整 | 保留，主讲义 |
...
| [07–09 讲义：H5-01](../chinese-guides/content-audit-07-09.md#h5-01) | viewport/DPR/响应式/安全区/横竖屏/字体缩放和三类视口单位 | 保留，主讲义 |
...
| [07–09 讲义：H5-02](../chinese-guides/content-audit-07-09.md#h5-02) | Pointer、passive、VisualViewport、滚动链、软键盘和双端故障注入 | 保留，主讲义 |
...
| 资料 | 全文观察 | 当前判定 |
| --- | --- | --- |
| [07–09 讲义：COMP-01](../chinese-guides/content-audit-07-09.md#comp-01) | 跨框架职责、API、组合、无障碍、反例和验收 | 保留，主讲义 |
...
| [07–09 讲义：COMP-02](../chinese-guides/content-audit-07-09.md#comp-02) | 受控/非受控唯一所有者、模式切换、异步竞态和最小句柄 | 保留，主讲义 |
...
| 资料 | 全文观察 | 当前判定 |
| --- | --- | --- |
| [07–09 讲义：NODE-01](../chinese-guides/content-audit-07-09.md#node-01) | 阶段/微任务、当前版本实测、延迟、分片/worker 和超纲术语 | 保留，主讲义 |
...
| [07–09 讲义：NODE-02](../chinese-guides/content-audit-07-09.md#node-02) | Stream/Buffer、背压、pipeline、取消、文件替换、错误和故障矩阵 | 保留，主讲义 |
...
| [07–09 讲义：NODE-04](../chinese-guides/content-audit-07-09.md#node-04) | HTTP 生命周期、安全上下文、deadline、取消/重试/幂等、连接/过载、观测和关闭 | 保留，主讲义 |

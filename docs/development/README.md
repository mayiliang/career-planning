...
| 学习投入 | 五阶段预计耗时；按 15 分钟粒度排期，默认每日容量上限 390 分钟 |
| 部署 | 本地启动，服务仅绑定 `127.0.0.1` |
| 进度重置 | 设置页提供学习进度重置，清学习证据并按最新版 48 周模板重建计划，保留求职和项目资产 |
...
- 20 个领域、190 个知识点全部自动导入，资料、考核和通过标准不丢失。
- 190 个知识点至少各有 2 个可直达资料链接，五阶段耗时完整，计划每日预计投入不超过 390 分钟且按北京时间显示。
...
| 知识点、资料、耗时、周计划 | `docs/knowledge/knowledge-base/README.md`、`learning-resource-guide.md`、个人 48 周计划和相关 CSV |

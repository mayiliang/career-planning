...
严格考核题、资料与勾选状态统一维护在 [Vue 3 项目开发知识清单](../knowledge/knowledge-base/11-vue-development.md)。开发时还必须持续更新 `docs/vue-learning-guide.md`，用仓库中的真实文件讲解已经完成的实现。
